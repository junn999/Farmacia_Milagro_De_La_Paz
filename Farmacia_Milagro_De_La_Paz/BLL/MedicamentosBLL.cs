...
namespace Farmacia_Milagro_De_La_Paz.BLL
{
    public class MedicamentosBll
    {
        ...
        public MedicamentosBll(int id, string nombre_del_producto, string presentacion, string fecha_de_caducidad, string precio_de_compra, string precio_de_venta, string ganancia, string inventario)
        {
            this.id = id;
